...
public class UserDB {
    ...
    private static final String INSERT_FROM_FILE = "INSERT INTO usuario(id,nombre,username,password,email,fecha_nacimiento,saldo,tipo,direccion,cui) VALUES(?,?,?,?,?,?,?,?,?,?)";
    private static final String INSERT = "INSERT INTO usuario(nombre,username,password,email,fecha_nacimiento,saldo,tipo,direccion,cui) VALUES(?,?,?,?,?,?,?,?,?)";
    private static final String UPDATE = "UPDATE usuario SET nombre = ?, username = ?, password = ?, email = ?, fecha_nacimiento = ?, saldo = ?, direccion = ?, cui = ? WHERE id = ?";
